...
public class MockServiceTest {
    ...
    @Test
    public void 챔피언이름을_입력하면_무조건_베인을_리턴(){
        Champion champion = mock(Champion.class);
        champion.setName("아리");
        ...
        //assertThat(champion.getName(), is("아리"));
    }

    // 2. 챔피언 이름으로 야스오를 저장하면, doThrow를 사용하여 Exception이 발생하도록 테스트 하세요.
    @Test(expected = IllegalArgumentException.class)
    public void shouldException_ChampionName_Yasuo(){
        Champion champion = mock(Champion.class);
    ...
    @Test
    public void shouldAtLeastTwoTimesInvocationForGetChampionName(){
        Champion champion = mock(Champion.class);
    ...
    @Test
    public void PassWhenShouldNotChampionGetName(){
        Champion champion = mock(Champion.class);
    ...
    public void shouldOneTimeInvocationIn200msForChampionGetName(){
        ...
        //verify(champion, timeout(10).atLeastOnce()).getName();
    }
...
//        verify(mockRepository, times(1)).findByName(anyString());
        when(mockService.findByName(anyString())).thenReturn(new Champion("루시안","서폿",5));
        String championName = mockService.findByName("애쉬").getName();
        assertThat(championName,is("루시안"));
        verify(mockRepository, times(1)).findByName(anyString());
    }
    ...
    @Test
    public void findChampionNameFakeReturnPositionAndCheck(){
    ...
    public void testSkinCountAndInvocationOneTimeWhenFindChampion(){
        ...
        assertThat(mockService.findByName("로블링").getHasSkinCount(),is(3));
        verify(mockRepository,times(1)).findByName(anyString());
    }
